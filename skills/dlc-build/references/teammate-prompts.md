...
5. Worker prompts should reference the plan tasks by number for trackability
6. **Copy full task text** into each worker prompt — workers should not need to read the plan independently
