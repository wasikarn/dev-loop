...
# Saves critical Devflow session context before compaction truncates conversation history.
...
# Check for active Devflow session artifacts
CONTEXT_FILE="$ARTIFACT_DIR/devflow-context.md"
...
cat <<EOF
<devflow-pre-compact>
Active Devflow session detected before compaction.
